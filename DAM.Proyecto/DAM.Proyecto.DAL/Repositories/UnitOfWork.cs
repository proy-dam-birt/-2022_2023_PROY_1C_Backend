...
namespace DAM.Proyecto.DAL.Repositories
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IEventosEuskadiRepository EventosEuskadiRepo { get; private set; }
        public ITipoActividadRepository TipoActividadRepo { get; private set; }
        ...
        {
            _context = context;
            EventosEuskadiRepo = new EventosEuskadiRepository(_context);
            TipoActividadRepo = new TipoActividadesRepository(_context);
